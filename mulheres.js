...
const cors = require('cors')//aqui estou trazendo o pacote cors que permite consumir essa API do frontEnd
...
app.use(router.delete('/mulheres/:id', deletaMulher))//configurei a rota DELETE/melheres
